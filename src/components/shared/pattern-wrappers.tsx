...
interface DiagonalPatternWrapperProps {
  className?: string
...
export const StripesPatternWrapper: React.FC<DiagonalPatternWrapperProps> = ({
  children,
  className,
  position = 'left',
  childrenClassName,
...
interface DiagonalBorderProps {
  position?: BorderPosition
  className?: string
}

export const DiagonalBorder: React.FC<DiagonalBorderProps> = ({
  position = 'bottom',
  className,
}) => {
  const borderClasses =
